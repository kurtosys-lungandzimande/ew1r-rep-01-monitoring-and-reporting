...
- [x] Slack alert consumers confirmed — alerts-data-operations and alert-app-allow2fa-disabled are active Grafana alerts triggered by REP_CLIENT_CONFIG_CHANGES_REPORT and REP_CLIENT_APP_AUTH_CONFIG_CHANGES_REPORT. Fed by DBA_VCC_MEMSQL_DAILY_CHECKS. Stale since May 2026. Must be retired on decommission.
